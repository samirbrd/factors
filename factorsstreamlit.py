...
path_string_1 = os.path.join(script_dir, "factor_backtests") + os.sep
path_string_2 = os.path.join(script_dir, "factor_backtests", "Low Vol") + os.sep
